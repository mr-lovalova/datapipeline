...
def _collect_schema_entries(runtime: Runtime, configs, group_by: str, *, cadence_strategy: str) -> tuple[list[dict], int]:
...
def materialize_vector_schema(runtime: Runtime, task_cfg: VectorSchemaConfig) -> Tuple[str, Dict[str, object]] | None:
    ...
    feature_entries, feature_vectors = _collect_schema_entries(
    ...
    if task_cfg.include_targets:
        ...
        target_entries, target_vectors = _collect_schema_entries(
